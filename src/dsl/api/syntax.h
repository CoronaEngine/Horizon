...
#define $if(...) ::horizon::dsl::detail::IfStmtBuilder::create_with_source_location("if: " + $source_location, __VA_ARGS__) / [&]()
#define $else % [&]()
#define $elif(...) *[&] {                                                                                           \
...
#define $switch(...) ::horizon::dsl::detail::SwitchStmtBuilder::create_with_source_location("switch: " + $source_location, __VA_ARGS__) \
    *[&](::horizon::dsl::Case case_,                                                                                                    \
         ::horizon::dsl::Default default_)

#define $case(...) case_("switch case: " + $source_location, __VA_ARGS__) \
    *[&](::horizon::dsl::Break break_)

#define $break break_("break: " + $source_location)
#define $default default_("default: " + $source_location) *[&](::horizon::dsl::Break break_)
...
#define $scope ::horizon::dsl::detail::ScopeStmtBuilder("scope " + $source_location) + [&]()

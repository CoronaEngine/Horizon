...
void run_example_edsl_ibl()
{
    ...
    desc.depth_attachment = Corona::Horizon::DepthAttachmentDesc::with_format(Corona::Horizon::Format::D32, "example_ibl.depth");
    ...
    Aggregate<IblEdslUniformProxy> ubo;
    ...
    TextureCube<fvec4> texCube;
    TextureCube<fvec4> texCubeIrr;
    ...
    Corona::Horizon::RasterizerPipeline rasterizer(
